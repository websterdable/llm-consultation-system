...
Для ускорения ответа и улучшения пользовательского опыта в Celery-задачу добавлен системный промпт, инструктирующий модель отвечать кратко (3-4 предложения). 
